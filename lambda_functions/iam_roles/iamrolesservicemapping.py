...
def lambda_handler(event, context):
    ...
    Returns:
        It return List of IAM role and its associated services to another lambda function.

    Raises:
        EC2 instance details: Raise error if ec2 describe_instances api not execute
    """
    ...
    for iterator in range(len(resource_file_content)):
        ...
        try:
            ...
            logging.error("Error invoking the lambda: " + str(e))
