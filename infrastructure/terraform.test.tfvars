...
total_account_cost_cronjob = "cron(0/15 * * * ? *)"     // flexible can be set according to need
slack_channel_url="YOUR-WEBHOOK-URL"                // Enter your Slack Webhook URL
budget_amount = 1                                   // Enter budget amount for the total account
services_budget_amount = 0.2                        // Enter Budget allocated for the services per region
iam_budget_amount = 2                               // Enter the budget allocated for each iam user
bucket_name = "example-metadata-storage"            // Enter your bucket name-metadata-storage
