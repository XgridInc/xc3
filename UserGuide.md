...
Thank you for your interest in X-CCC! This email serves as a quick guide to help you get started with the project.
...
Once X-CCC infrastructure deployed in your AWS Account, Users needs to be added in Cognito pool with requested role (admin/editor/viewer) in respective cognito group. User get random username/password from cognito then he/she can set password on domain by sign in using random credentials.
...
## Getting Started with X-CCC

Once you've logged in on X-CCC, you can start using dashboards.
...
If you have any questions or run into issues while using X-CCC, you can ask for help by sending an email to <a href="mailto:xccc@xgrid.co">xccc@xgrid.co</a>

We hope this guide helps you get started with X-CCC. If you have any feedback or suggestions for the project, please let us know!

Best regards,

[Xgrid Cloud Cost Control Team]